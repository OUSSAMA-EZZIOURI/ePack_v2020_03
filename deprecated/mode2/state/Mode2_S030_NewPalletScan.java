...
public class Mode2_S030_NewPalletScan implements Mode2_State {
    ...
    public void doAction(Mode2_Context context) {
        ...
        if (barcode.equals(this.palletNumber)) {
            ...
            //UILog.infoDialog("Closing format for mode 1: "+context.getBaseContainerTmp().getClosingSheetFormat());
            bc.create(bc);
            ...
            if (bc.getQtyExpected() == 1) {
                for (int copies = 0; copies < bc.getClosingSheetCopies(); copies++) {
                    ...
                    try {
                        ...
                        Logger.getLogger(Mode2_S030_NewPalletScan.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
                Helper.startSession();
