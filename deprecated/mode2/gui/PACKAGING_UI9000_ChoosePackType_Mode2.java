...
public final class PACKAGING_UI9000_ChoosePackType_Mode2 extends javax.swing.JDialog {
    ...
    private void mappingValsToContext(int ucs_id) {
        ...
        PackagingVars.mode2_context.getBaseContainerTmp().setUcsId(u.getId());
        PackagingVars.mode2_context.getBaseContainerTmp().setHarnessPart(GlobalVars.HARN_PART_PREFIX + u.getHarnessPart());
        PackagingVars.mode2_context.getBaseContainerTmp().setSupplierPartNumber(u.getSupplierPartNumber());
        PackagingVars.mode2_context.getBaseContainerTmp().setHarnessIndex(u.getHarnessIndex());
        PackagingVars.mode2_context.getBaseContainerTmp().setPackType(u.getPackType());
        PackagingVars.mode2_context.getBaseContainerTmp().setQtyExpected(u.getPackSize());
        PackagingVars.mode2_context.getBaseContainerTmp().setStdTime(u.getStdTime());
        PackagingVars.mode2_context.getBaseContainerTmp().setAssyWorkstation(u.getAssyWorkstationName());
        PackagingVars.mode2_context.getBaseContainerTmp().setSegment(u.getSegment());
        PackagingVars.mode2_context.getBaseContainerTmp().setWorkplace(u.getWorkplace());
        PackagingVars.mode2_context.getBaseContainerTmp().setUcsLifes(u.getLifes());
        PackagingVars.mode2_context.getBaseContainerTmp().setComment(u.getComment());
        PackagingVars.mode2_context.getBaseContainerTmp().setSpecial_order(u.getSpecialOrder());
        PackagingVars.mode2_context.getBaseContainerTmp().setOrder_no(u.getOrderNo());
        PackagingVars.mode2_context.getBaseContainerTmp().setChoosen_pack_type(u.getPackType());
        PackagingVars.mode2_context.getBaseContainerTmp().setNetWeight(u.getNetWeight());
        PackagingVars.mode2_context.getBaseContainerTmp().setGrossWeight(u.getGrossWeight());
        PackagingVars.mode2_context.getBaseContainerTmp().setVolume(u.getVolume());
        PackagingVars.mode2_context.getBaseContainerTmp().setPrice(u.getPrice());
        PackagingVars.mode2_context.getBaseContainerTmp().setEngChange(u.getEngChange());
        PackagingVars.mode2_context.getBaseContainerTmp().setEngChangeDate(u.getEngChangeDate());
        PackagingVars.mode2_context.getBaseContainerTmp().setProject(u.getProject());
        PackagingVars.mode2_context.getBaseContainerTmp().setWarehouse(u.getWarehouse());
        PackagingVars.mode2_context.getBaseContainerTmp().setDestination(u.getDestination());
        PackagingVars.mode2_context.getBaseContainerTmp().setArticleDesc(u.getArticleDesc());
        PackagingVars.mode2_context.getBaseContainerTmp().setLabelPerPiece(u.isLabelPerPiece());
        PackagingVars.mode2_context.getBaseContainerTmp().setPriority(u.getPriority());
        ...
        for (int copies = 0; copies < configUcs.getOpenningSheetCopies(); copies++) {
            ...
            try {
                ...
                if (newPalletNumber != -1) { //Bingo !!
                    ...
                    //############# PASSE TO S041 STATE ###############
                    UILog.info("APP_INFO0006 : Openning new container for the first harness part ");
                    System.out.print(PackagingVars.mode2_context.getBaseContainerTmp().getHarnessPart().substring(1));
            ...
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                if (result.isEmpty()) {
                    if (Integer.valueOf(GlobalVars.APP_PROP.getProperty("UNIQUE_PALLET_PER_PACK_TYPE")) == 1) {
                        ...
                        System.out.println("UNIQUE_PALLET_PER_PACK_TYPE check query \n " + str);
                        Helper.sess.getTransaction().commit();
                        result = query.list();
