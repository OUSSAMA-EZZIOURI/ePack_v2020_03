...
/**
 * HisClosingPalPrint generated by hbm2java
 */
@Entity
@Table(name = "his_galia_print")
public class HisClosingPalPrint extends DAO implements java.io.Serializable {
    ...
    public HisClosingPalPrint() {
    }

    public HisClosingPalPrint(String harnessPart, String supplierName, String supplierPartNumber, String harnessIndex, int qty, String closingPalet, String state, String reprint) {
    ...
    public HisClosingPalPrint(String harnessPart, String supplierName, String supplierPartNumber, String harnessIndex, int qty, String closingPalet, String state, int writeId, Date writeTime, String reprint) {
    ...
    public HisClosingPalPrint(String harnessPart, String supplierName, String supplierPartNumber, String harnessIndex, int qty, String pack_type, String closingPallet, String printState, String reprint, double grossWeight, double volume, String engChange, String articleDesc, String project, Date engChangeDate, String warehouse) {
        this.harnessPart = harnessPart;
        this.supplierName = supplierName;
        this.supplierPartNumber = supplierPartNumber;
        this.harnessIndex = harnessIndex;
        this.qty = qty;
        this.packType = pack_type;
...
//        HibernateUtil.close();
    ...
    public String toString() {
        return "HisClosingPalPrint{" + "createTime=" + createTime + ", writeTime=" + writeTime + ", createId=" + createId + ", writeId=" + writeId + ", harnessPart=" + harnessPart + ", supplierName=" + supplierName + ", supplierPartNumber=" + supplierPartNumber + ", harnessIndex=" + harnessIndex + ", qty=" + qty + ", closingPallet=" + closingPallet + ", printState=" + printState + ", reprint=" + reprint + ", grossWeight=" + grossWeight + ", volume=" + volume + ", engChange=" + engChange + ", articleDesc=" + articleDesc + ", project=" + project + ", engChangeDate=" + engChangeDate + '}';
    }
