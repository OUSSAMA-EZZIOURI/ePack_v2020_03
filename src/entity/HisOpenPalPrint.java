...
/**
 * HisOpenPalPrint generated by hbm2java
 */
@Entity
@Table(name = "his_pallet_print")
public class HisOpenPalPrint extends DAO implements java.io.Serializable {
    ...
    public HisOpenPalPrint(ManufactureUsers user, String harnessPart, String harnessIndex, int packSize, String packType, String printState, String reprint, String supplier_part_number, double grossWeight, double volume, String engChange, String articleDesc, String project, Date engChangeDate) {
    ...
    public HisOpenPalPrint(ManufactureUsers user, String harnessPart, String harnessIndex, String supplier_part_number, int packSize,
...
//
//    public HisOpenPalPrint(Date createTime, Date writeTime, int createId,
