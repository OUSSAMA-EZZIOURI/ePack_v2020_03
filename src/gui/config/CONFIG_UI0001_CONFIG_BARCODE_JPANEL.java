 ...
 * @author user
 */
public class CONFIG_UI0001_CONFIG_BARCODE_JPANEL extends javax.swing.JPanel {
    JTabbedPane parent;
     ...
     * @param modal
     */
    public CONFIG_UI0001_CONFIG_BARCODE_JPANEL(JTabbedPane parent) {
    ...
    CONFIG_UI0001_CONFIG_BARCODE_JPANEL() {
        initComponents();
        initGui(parent);
        refresh();
    }
        ...
        this.barcode_table.addMouseListener(
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    ...
                    config_index_txt.setText(aux.getConfigIndex());
    ...
    private void initComponents() {
        ...
        config_index_txt = new javax.swing.JTextField();
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGap(18, 18, 18)
                                                .addComponent(config_index_txt, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE))))))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel10)
                        .addComponent(config_index_txt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(msg_lbl, javax.swing.GroupLayout.PREFERRED_SIZE, 1010, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    public void reload_barcode_table_data(List<Object[]> resultList) {
        ...
        for (Object[] obj : resultList) {
            ...
            oneRow.add(String.valueOf(obj[7])); //Harness Index
    ...
    private void refresh() {
        ...
        try {
            String query_str = " SELECT "
                    ...
                    + " c.config_index AS config_index "
    ...
    private void save_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_btnActionPerformed
        if (id_txt.getText().isEmpty()) { // ID Label is empty, then is a new Object
            ...
            cb.setConfigIndex(config_index_txt.getText());
            cb.create(cb);
            clearFields();
            ...
            aux.setConfigIndex(config_index_txt.getText());
            aux.update(aux);
            clearFields();
    ...
    private javax.swing.JTextField config_index_txt;
