...
//import gui.packaging.reports.PACKAGING_UI0015_DroppedPallets;
//import gui.packaging.reports.PACKAGING_UI0018_OpenPallets;
 ...
 * @author user
 */
public final class PACKAGING_UI0001_Main_Mode3 extends javax.swing.JFrame implements KeyListener, WindowListener {

    String str = null;
    public Mode3_State state = PackagingVars.mode3_context.getState();
    ...
    //########################################################################
    public PACKAGING_UI0001_Main_Mode3() {
    }
     ...
     * @param parent
     */
    public PACKAGING_UI0001_Main_Mode3(Object[] context, MainFrame parent) {
        this.parent = parent;
        initComponents();
    ...
    private void initComponents() {
        ...
        harnessTypeFilterBox.setEnabled(false);
                    ...
                    .addGroup(panel_topLayout.createSequentialGroup()
                        .addGroup(panel_topLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(panel_topLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(connectedUserName_label, javax.swing.GroupLayout.PREFERRED_SIZE, 966, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(113, 113, 113)
    ...
    //########################################################################
    //################ Reset GUI Component to Mode3_State S01 ######################
    //########################################################################
    public void logout() {
        try {
            ...
            //Reset the state
            state = new Mode3_S010_UserCodeScan();

            this.clearContextSessionVals();

            //Reset Image
            PackagingVars.Packaging_Gui_Mode3.img_lbl.setIcon(state.getImg());
            //Clear Scan Box
            PackagingVars.Packaging_Gui_Mode3.requestedPallet_label.setText("");
            //Enable Project Box
            ...
            PackagingVars.Packaging_Gui_Mode3.setHarnessTypeFilterBoxState(true);
            disableAdminMenus();
    ...
    private void scan_txtboxKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_scan_txtboxKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            state.doAction(PackagingVars.mode3_context);
