 ...
 */
public class PACKAGING_UI0016_DroppedHarness_JPANEL extends javax.swing.JPanel {
     ...
     */
    public PACKAGING_UI0016_DroppedHarness_JPANEL(java.awt.Frame parent, boolean modal) {
        initComponents();
        this.initGui();
        this.refresh();
    }
    ...
    private void initTimeSpinners() {
        ...
        try {
            ...
            Logger.getLogger(PACKAGING_UI0016_DroppedHarness_JPANEL.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        north_panel.setToolTipText("Pièces annulées");
        ...
        jLabel6.setText("Pièces annulées");
