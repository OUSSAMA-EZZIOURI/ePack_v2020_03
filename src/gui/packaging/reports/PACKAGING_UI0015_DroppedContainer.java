 ...
 */
public class PACKAGING_UI0015_DroppedContainer extends javax.swing.JDialog {
     ...
     */
    public PACKAGING_UI0015_DroppedContainer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.initGui();
        this.refresh();
    ...
    private void initTimeSpinners() {
        ...
        try {
            ...
            Logger.getLogger(PACKAGING_UI0015_DroppedContainer.class.getName()).log(Level.SEVERE, null, ex);
        }
