...
public class PACKAGING_UI0013_PalletWaiting extends javax.swing.JDialog {
    ...
    public PACKAGING_UI0013_PalletWaiting(java.awt.Frame parent, boolean modal) {
        ...
        if (PackagingVars.mode3_context.getBaseContainerTmp().getHarnessType() == null) {
            loadContainer("ALL");
            continue_btn.setVisible(false);
        } else {
            loadContainer(PackagingVars.mode3_context.getBaseContainerTmp().getHarnessType());
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Attente ferméture");
        ...
        jLabel11.setText("Type packaging");
        ...
        jLabel4.setText("Quantité scanée");
        ...
        continue_btn.setText("Continuer la ferméture");
