 ...
 */
public class PACKAGING_UI0018_OpenPallets_JPANEL extends javax.swing.JPanel {
     ...
     */
    public PACKAGING_UI0018_OpenPallets_JPANEL(JTabbedPane parent) {
        initComponents();
        this.initGui(parent);
    }
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2) {
                    if (PackagingVars.context.getUser().getAccessLevel() == GlobalVars.PROFIL_ADMIN || PackagingVars.context.getUser().getAccessLevel() == GlobalVars.PROFIL_WAREHOUSE_AGENT) {
                        new PACKAGING_UI0010_PalletDetails_JPANEL(parent, String.valueOf(open_result_table.getValueAt(open_result_table.getSelectedRow(), PALLET_NUMBER_COLINDEX)), "", 1, true, true, true).setVisible(true);
                    } else {
                        new PACKAGING_UI0010_PalletDetails_JPANEL(parent, String.valueOf(open_result_table.getValueAt(open_result_table.getSelectedRow(), PALLET_NUMBER_COLINDEX)), "", 1, false, false, false).setVisible(true);
                    }
                }
            }
        }
    ...
    private void refresh() {
         ...
         *
         * startDate = dateDf.format(startDatePicker.getDate()) + " " +
         * startTime; endDate = dateDf.format(endDatePicker.getDate()) + " " +
         * endTime;
         */
        try {
            ...
            JTableHelper.sizeColumnsToFit(open_result_table);
    ...
    private void initComponents() {
        ...
        open_result_table.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        ...
        open_result_table.setSelectionMode(javax.swing.ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
                ...
                .addGroup(north_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(north_panelLayout.createSequentialGroup()
                        .addGroup(north_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(result_table_scroll, javax.swing.GroupLayout.PREFERRED_SIZE, 808, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        north_panelLayout.setVerticalGroup(
            ...
            .addGroup(north_panelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(result_table_scroll, javax.swing.GroupLayout.PREFERRED_SIZE, 721, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(14, 14, 14)
