...
public final class PACKAGING_UI9001_DropContainerConfirmation extends javax.swing.JDialog {
     ...
     *
     */
    public PACKAGING_UI9001_DropContainerConfirmation(javax.swing.JPanel parent, boolean modal, BaseContainer bc, int scanMode) {
        //super(parent, modal);
        initComponents();
        initGui(parent);
    ...
    private void initComponents() {
        ...
        ok_btn.setBackground(java.awt.Color.red);
    ...
    private void ok_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ok_btnActionPerformed
        ...
        if (!dropFeedback_txtbox.getText().isEmpty()) {
            ...
            if (confirmed == 0) {
                this.bc.setDeleteTime(new Date());
                this.bc.setContainerState(GlobalVars.PALLET_DELETED);
                this.bc.setContainerStateCode(GlobalVars.PALLET_DELETED_CODE);
                
                Helper.sess.beginTransaction();
                String sqlQuery = "UPDATE BaseHarness SET deleted = :deleted WHERE palletNumber = :palletNumber";
                Helper.sess.createQuery(sqlQuery)
                        .setParameter("deleted", true)
                        .setParameter("palletNumber", this.bc.getPalletNumber())
                        .executeUpdate();
                ...
                dp.setCreateId(this.bc.getCreateId());
...
*/
                ...
                try {
                    ...
                    this.parentJpanel.setOkText(String.format(MSG_DROP_SUCCESS, this.bc.getPalletNumber()));
                    ...
                    //Print delete OK message
                    this.parentJframe.setOkText(String.format(MSG_DROP_SUCCESS, this.bc.getPalletNumber()));
