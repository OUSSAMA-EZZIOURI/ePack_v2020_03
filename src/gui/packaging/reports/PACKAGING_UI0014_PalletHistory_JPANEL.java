 ...
 * @author user
 */
public final class PACKAGING_UI0014_PalletHistory_JPANEL extends JPanel {
     ...
     * @param PalletNumber 
     */
    public PACKAGING_UI0014_PalletHistory_JPANEL(JTabbedPane parent, String PalletNumber) {
        initComponents();
        initGui(parent);
    ...
    public void reload_history_table_data(List resultList) {
        ...
        //Desable table edition
        disableEditingTable();
        JTableHelper.sizeColumnsToFit(history_table);
    }
    ...
    private void search_txtboxActionPerformed(ActionEvent evt) {//GEN-FIRST:event_search_txtboxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_search_txtboxActionPerformed

    private void search_txtboxKeyPressed(KeyEvent evt) {//GEN-FIRST:event_search_txtboxKeyPressed
    ...
    private void search_txtboxKeyReleased(KeyEvent evt) {//GEN-FIRST:event_search_txtboxKeyReleased
        if (!search_txtbox.getText().isEmpty()) {
            refresh_btn.setEnabled(true);
        } else {
            refresh_btn.setEnabled(false);
    ...
    private void search_txtboxKeyTyped(KeyEvent evt) {//GEN-FIRST:event_search_txtboxKeyTyped
        if (!search_txtbox.getText().isEmpty()) {
            refresh_btn.setEnabled(true);
        } else {
            refresh_btn.setEnabled(false);
    ...
    javax.swing.JTable history_table;
    javax.swing.JLabel jLabel1;
    javax.swing.JPanel jPanel1;
    javax.swing.JLabel message_lbl;
    javax.swing.JLabel pallet_number_lbl;
    javax.swing.JButton refresh_btn;
    javax.swing.JTextField search_txtbox;
    javax.swing.JScrollPane table_scroll;
