 ...
 * @author user
 */
public class S004_DISPATCH_LABEL_NO implements ControlState {
     ...
     */
    public S004_DISPATCH_LABEL_NO(BaseContainer bc) {
        this.bc = bc;
    ...
    public void doAction(WarehouseControlContext context) {
        ...
        if (!WarehouseHelper.checkDispatchLabelSerialNumFormat(this.dispatchLabelNo)) {
            ...
            LoadPlanLine objResult = isDispatchSerialExist((this.dispatchLabelNo.startsWith(GlobalVars.DISPATCH_SERIAL_NO_PREFIX)) ? this.dispatchLabelNo.substring(1) : this.dispatchLabelNo);
            if (objResult != null) {
                SoundHelper.PlayErrorSound(null);
                ...
                this.dispatchLabelNo = (this.dispatchLabelNo.startsWith(GlobalVars.APP_PROP.getProperty("DISPATCH_SERIAL_NO_PREFIX"))) ? this.dispatchLabelNo.substring(1) : this.dispatchLabelNo;
