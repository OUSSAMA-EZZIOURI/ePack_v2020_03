 ...
 * @author user
 */
public class WAREHOUSE_FG_UI0001_SCAN_JPANEL extends javax.swing.JPanel {
     ...
     * @param u
     */
    public WAREHOUSE_FG_UI0001_SCAN_JPANEL(Object[] context, JTabbedPane parent, ManufactureUsers u) {
        initComponents();
     ...
     *
     */
    public WAREHOUSE_FG_UI0001_SCAN_JPANEL(JTabbedPane parent, boolean modal,
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Numéro palette");
        ...
        jLabel15.setText("Numéro palette");
        ...
        set_to_stored_btn.setText("Changer statut à \"Stored\"");
        ...
        try {
            ...
            if (bc != null) {
                if (bc.getContainerStateCode().equals(GlobalVars.PALLET_BLOCKED_CODE)) {
                    ...
                    PackagingVars.Packaging_Gui_Mode3.getFeedbackTextarea().setText(APP_ERR0051);
                    return false;
                } else {
                    Helper.startSession();
