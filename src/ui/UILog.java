...
public class UILog {
    ...
    public static void infoDialog(Component parentComponent, String[] msg, Object... args) {
        JOptionPane.showMessageDialog(parentComponent, String.format(i18n(msg[0]), args), msg[0], JOptionPane.INFORMATION_MESSAGE);
    }
     ...
     */
    public static void severeDialog(Component parentComponent, String msg, String title) {
     ...
     * @param title the <code>String</code> title of the dialog
     */
    public static void causeDialog(Component parentComponent, SQLException e) {
...
//        System.out.println("StringBuilder "+sb.toString());        
        ...
        JOptionPane.showMessageDialog(parentComponent, scrollPane, e.getClass().getCanonicalName(), JOptionPane.ERROR_MESSAGE);

    }

    public static void severeSQLDialog(Component parentComponent, SQLException e) {
        StringBuilder sb = new StringBuilder(e.toString());
        for (StackTraceElement ste : e.getStackTrace()) {
            sb.append("\n\tat ");
            sb.append(ste);
