...
INSERT INTO public.config_warehouse(
	...
	VALUES (16, 'PACKAGING WAREHOUSE', 'W64-PM-DUCATI', 'DUCATI', 'PACKAGING')
	ON CONFLICT (warehouse, project) DO NOTHING
...
-- Mise à jour de la FDP selon le supplier part number 100% VMI
UPDATE public.config_ucs	
        SET destination='VMI'
